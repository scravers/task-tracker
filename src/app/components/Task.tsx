...
const style = {
  ...
  input: `border p-1 ml-2 w-full text-xl max-w-[200px] text-sm`,
  text_small: `ml-2 resize-y min-w-[30px]`,
  text_medium: `ml-2 resize-y w-full max-w-[150px]`,
      ...
      <div className="flex justify-end">
        <button 
          ...
          onClick={() => {
            ...
            editTask(task, task.id, title, desc, deadline, priority, status)
            }
          }
